# ---------------------------------------------------------------------------
# OVERLAY PORT: libaec (GitHub mirror)
#
# Stock vcpkg fetches libaec from gitlab.dkrz.de (k202009/libaec). That host is
# frequently unreachable (outright connection refusal), which blocks clean builds
# and breaks our offline source vault. This overlay fetches the byte-identical
# release from the upstream author's GitHub mirror instead. Only the download
# origin -- and therefore the SHA512 -- differ from the stock port; the source
# code and all build steps below are unchanged.
#
# Maintenance: when bumping libaec, update VERSION (vcpkg.json), REF, and SHA512.
# ---------------------------------------------------------------------------
vcpkg_from_github(
